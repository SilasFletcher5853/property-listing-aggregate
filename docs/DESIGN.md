...
> Design notes for **property-listing-aggregate** — a runnable typescript example that Typed TypeScript collector for property listings and inspection reminders.
...
- **Feature code** — the actual task: property aggregation.
